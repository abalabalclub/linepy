...
kb.log("Channel Token : " + str(channelToken))

sw = LINE()
#sw = LINE("TOKEN")
#sw = LINE("Email","Password")
sw.log("Auth Token : " + str(kc.authToken))
channelToken = sw.getChannelResult()
sw.log("Channel Token : " + str(channelToken))
...
wait = {
    ...
    "selfbot":True,
    "mention":"Sini gabung",
    "Respontag":"Apa ngetag ngetag kangen ya?",
    "welcome":"Welcome...",
    "comment":"Auto like By: Matt",
    "comment1":"Autolike by:\nMatt",
    "message":"HAI KAK! NGEADD NGEADD NIH YEE"
}
protect = {
    "pqr":[],
    "pinv":[],
...
def sendTextTemplate4(to, text):
    data = {
                                "type": "flex",
                                "altText": "{} Klik cover add owner pandawabot".format(cl.getProfile().displayName),
                                "contents": {
  "type": "bubble",
  "body": {
    "type": "box",
            ...
            if mid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        ki.kickoutFromGroup(op.param1,[op.param2])
                        ki.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid])
                        cl.acceptGroupInvitation(op.param1)
                        kk.cancelGroupInvitation(op.param1,[op.param2])
                    except:
                        try:
                            ...
                            kk.kickoutFromGroup(op.param1,[op.param2])
                            cl.acceptGroupInvitation(op.param1)
                            kk.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid])
                            kc.cancelGroupInvitation(op.param1,[op.param2])
                        except:
                            try:
                                ...
                                kc.kickoutFromGroup(op.param1,[op.param2])
                                cl.acceptGroupInvitation(op.param1)
                                kc.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid])
                                ...
                                try:
                                    ...
                                    kb.kickoutFromGroup(op.param1,[op.param2])
                                    cl.acceptGroupInvitation(op.param1)
                                    kb.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid])
                                    kb.cancelGroupInvitation(op.param1,[op.param2])
                                except:
                                        try:
                                            G = ki.getGroup(op.param1)
                                ...
                                ki.cancelGroupInvitation(op.param1,[op.param2])
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                ki.acceptGroupInvitation(op.param1)    
                                                cl.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid])
                                                ki.cancelGroupInvitation(op.param1,[op.param2])
                                                    except:
                                                        pass
                return
...
"【✔】Sticker2")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                               sendTextTemplate3(msg.to, "「🔑]Menu Sticker-Pandawa\n"
"【✔】Sepi\n"
"【✔】Kampret\n"
"【✔】Wkwk\n"
"【✔】Malas\n"
...
"【✔】「Ytmp4: Judul")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin or msg._from in staff:                                               
                               ...
                               sendTextTemplateku(msg.to, "Bot Pandawa Hadir om")
...
#===========BOT UPDATE============#
                        ...
                        elif "Gassauahahw tmp" in msg.text:
                           if msg._from in admin:
                            if msg.toType == 2:
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/~tetsunaki")
                        ...
                        elif "Gaa111hhhhhhhppss" in msg.text:
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/~tetsunaki")
                        ...
                        elif msg.text in ["Cipok","Tagall","Desah","Emuach","Assalamualaikum","Pagi","Siang","Sore","Malam","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ginfo = cl.getGroup(msg.to)
                                    cl.inviteIntoGroup(msg.to, [Zmid])
                                    sendTextTemplate(msg.to,"Ready stay "+str(ginfo.name)+" Siap Backup")
                                except:
                                    pass
                         ...
                         if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ki.sendMessage(msg.to, "Pandawa")
                               kk.sendMessage(msg.to, "Pandawa")
                               kc.sendMessage(msg.to, "Pandawa")
                               kb.sendMessage(msg.to, "Pandawa")
...
#=========== [ Hiburan] ============#  
                                ...
                                try:
                                    ...
                                    for i in range(len(st)):
                                        ...
                                        cl.createComment(str(sender), str(result), 'AutoLike')
...
#===========KICKOUT============#       
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                             if msg.toType == 2:
                                 ...
                                 sendTextTemplate(msg.to,"「 Sorry r̸o̸o̸m̸ n̸y̸a̸ k̸a̸m̸i̸ s̸i̸t̸a̸ s̸e̸e̸ y̸o̸u̸ s̸l̸a̸m̸ d̸a̸r̸i̸ TΣΔM Pandawa βΩT」")
                                 targets = []
                                 for g in gs.members:
                                     if _name in g.displayName:
                                         targets.append(g.mid)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "Pandawa HERE")
                                ki.sendMessage(msg.to, "Pandawa HERE")
                                kk.sendMessage(msg.to, "Pandawa HERE")
                                kc.sendMessage(msg.to, "Pandawa HERE")
                                kb.sendMessage(msg.to, "Males njirr")
                                cl.sendMessage(msg.to, "Goblok!!!")
