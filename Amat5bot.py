...
nadya = LINE("rahmat.sunandar11@gmail.com","Password")
...
ki = LINE()
#ki = LINE("TOKEN KAMU")
ki = LINE("kaswari0cell12345","Password")
...
creator = ["u9f49f64cd4ec2601d6d81420523a9971","u4d27e75137126f5e208daf06c0d8f9e5"]
    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                nadya.sendMessage(op.param1, "Halo {} maaf saya adalah bot\nTerima kasih sudah add saya.  ".format(str(nadya.getContact(op.param1).displayName)))
        if op.type == 13:
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    nadya.sendContact(to, "u4d27e75137126f5e208daf06c0d8f9e5")
