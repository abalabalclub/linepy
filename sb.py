...
Connect_to = {
    ...
    "Copy":False,
    "autoAdd":True,
    "PesanAdd":"Ciee Fans ADD diam diam\n Ada apa fans?",
    "ContactAdd":{},
    "autoBlock":False,
    "autoJoin":True,
    ...
    "WcText": "Welcome tod",
    "Leave":True,
    "LvText": "ciaah leave baperan dia",
    "Mic":False,
    "MicDel":False,
    "Adminadd":False,
    "AdminDel":True,
    ...
    "Ban":False,
    "Unban":False,
    "comment": "Dipaksa Like\nOwner:\nline.me/ti/p/~gugun.z",
    "Admin": {
        "u3def2e9374495a6879da3f01bcee33f8a":True #MID ADMIN TARO DISINI
    },
}
                ...
                if msg.contentType == 0:
                    if Connect_to["autoRead"] == True:
                        ...
                        if msgText.lower() == '_PYTHON3_':
                            ...
                            if man in Team or man in Connect_to["Admin"]:
                                no = time.time()
                                client.sendText("u4d27e75137126f5e208daf06c0d8f9e5", ' ')
                            ...
                            if man in Team or man in Connect_to["Admin"]:
                                ...
                                client.sendText(send,"Team\n\nOwner:\n"+msg+"\nAdmin:\n"+dpk_+"\n( %s ) BOT GRATIS" %(str(len(Owner)+len(Connect_to["Admin"]))))                                
                        ...
                        elif msgText.lower().startswith("mention"):
                            if man in Team or man in Connect_to["Admin"]:
                                gname = client.getGroup(send)
                                local = [contact.mid for contact in gname.members]
                                try:
                                    ...
                                    client.sendMessage(send, str(error))
                        elif msgText.lower().startswith("群標"):
                            if man in Team or man in Connect_to["Admin"]:
                                gname = client.getGroup(send)
                                local = [contact.mid for contact in gname.members]
                                try:
                                    ...
                                    client.sendMessage(send, str(error))
                        elif msgText.lower().startswith("tag"):
                            if man in Team or man in Connect_to["Admin"]:
                                gname = client.getGroup(send)
                                local = [contact.mid for contact in gname.members]
                                try:
                                    ...
                                    client.sendMessage(send, str(error))
                        elif msgText.lower().startswith("點名"):
                            if man in Team or man in Connect_to["Admin"]:
                                gname = client.getGroup(send)
                                local = [contact.mid for contact in gname.members]
                                try:
